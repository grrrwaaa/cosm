{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 667.0, 44.0, 737.0, 561.0 ],
		"bglocked" : 1,
		"defrect" : [ 667.0, 44.0, 737.0, 561.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r mix",
					"patching_rect" : [ 630.0, 405.0, 36.0, 20.0 ],
					"id" : "obj-22",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "jit.fpsgui",
					"mode" : 4,
					"patching_rect" : [ 525.0, 495.0, 80.0, 36.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 525.0, 450.0, 124.0, 20.0 ],
					"id" : "obj-20",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "prepend color",
					"patching_rect" : [ 105.0, 435.0, 84.0, 20.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 25.0, 69.0, 456.0, 300.0 ],
						"bglocked" : 0,
						"defrect" : [ 25.0, 69.0, 456.0, 300.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "pack 0. 0. 0.",
									"patching_rect" : [ 135.0, 210.0, 76.0, 20.0 ],
									"id" : "obj-4",
									"fontname" : "Arial",
									"numinlets" : 3,
									"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r reset",
					"patching_rect" : [ 105.0, 375.0, 45.0, 20.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 420.0, 195.0, 137.0, 20.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r reset",
					"patching_rect" : [ 420.0, 165.0, 45.0, 20.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b l",
					"patching_rect" : [ 345.0, 105.0, 32.5, 20.0 ],
					"id" : "obj-35",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r chladni",
					"patching_rect" : [ 345.0, 75.0, 56.0, 20.0 ],
					"id" : "obj-34",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.mesh cosm @draw_mode points @color 1 1 1 1 @scale 8",
					"patching_rect" : [ 75.0, 525.0, 345.0, 20.0 ],
					"id" : "obj-64",
					"fontname" : "Arial",
					"numinlets" : 9,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r fog",
					"patching_rect" : [ 90.0, 270.0, 35.0, 20.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "cosm chladni world object",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p navigate",
					"patching_rect" : [ 135.0, 120.0, 66.0, 20.0 ],
					"id" : "obj-57",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r step",
					"patching_rect" : [ 75.0, 120.0, 41.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "cosm.nav @position 0 0 0",
					"patching_rect" : [ 75.0, 150.0, 149.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.matrix chladni",
					"patching_rect" : [ 570.0, 180.0, 97.0, 20.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 255.0, 480.0, 123.0, 20.0 ],
					"id" : "obj-29",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.op @op - @val 0.5",
					"patching_rect" : [ 255.0, 195.0, 123.0, 20.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 255.0, 375.0, 138.0, 20.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.op @op *",
					"patching_rect" : [ 255.0, 285.0, 73.0, 20.0 ],
					"id" : "obj-32",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.noise 3 float32 8000",
					"patching_rect" : [ 255.0, 165.0, 137.0, 20.0 ],
					"id" : "obj-4",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "cosm.field",
					"patching_rect" : [ 525.0, 420.0, 65.0, 20.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numinlets" : 3,
					"numoutlets" : 3,
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 264.5, 513.5, 84.5, 513.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-64", 0 ],
					"hidden" : 0,
					"midpoints" : [ 99.5, 302.0, 84.5, 302.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 368.0, 152.0, 579.5, 152.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 149.5, 174.5, 129.5, 174.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 84.5, 144.5, 84.5, 144.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 84.5, 227.0, 144.5, 227.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-12", 0 ],
					"hidden" : 0,
					"midpoints" : [ 144.5, 144.5, 84.5, 144.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 264.5, 410.0, 534.5, 410.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-6", 1 ],
					"hidden" : 0,
					"midpoints" : [ 264.5, 400.0, 397.5, 400.0, 397.5, 323.0, 320.5, 323.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 429.5, 269.0, 318.5, 269.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-32", 1 ],
					"hidden" : 0,
					"midpoints" : [ 534.5, 479.0, 427.5, 479.0, 427.5, 275.0, 318.5, 275.0 ]
				}
