{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 396.0, 44.0, 1104.0, 594.0 ],
		"bglocked" : 1,
		"defrect" : [ 396.0, 44.0, 1104.0, 594.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 672.0, 350.0, 140.0, 20.0 ],
					"id" : "obj-4",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "setall 0.99, bang",
					"patching_rect" : [ 574.0, 168.0, 100.0, 18.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "In this patch, the field activity outlet accumulates onto the field itself (with some decay), letting the particles leave trails in the 3D field.",
					"linecount" : 4,
					"patching_rect" : [ 658.0, 56.0, 180.0, 52.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The second outlet of cosm.field can be used to track activity at the given points. Additional planes after the first three (X, Y, Z) are mapped onto the planes of the field matrix.",
					"linecount" : 5,
					"patching_rect" : [ 462.0, 56.0, 173.0, 64.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadbang",
					"patching_rect" : [ 574.0, 140.0, 60.0, 20.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 532.0, 322.0, 50.0, 18.0 ],
					"id" : "obj-2",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.gridshape cosm @shape sphere @automatic 0 @name balls @lighting_enable 1 @depth_enable 1 @smooth_shading 1 @color 0 1 1 1",
					"linecount" : 2,
					"patching_rect" : [ 462.0, 518.0, 567.0, 34.0 ],
					"id" : "obj-94",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.multiple cosm 1 @targetname balls @glparams position",
					"patching_rect" : [ 462.0, 488.0, 332.0, 20.0 ],
					"id" : "obj-95",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 924.0, 364.0, 20.0, 20.0 ],
					"id" : "obj-93",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ]
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "poly_mode $1 $1",
					"patching_rect" : [ 924.0, 392.0, 99.0, 18.0 ],
					"id" : "obj-91",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 840.0, 266.0, 50.0, 18.0 ],
					"id" : "obj-83",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p reposition",
					"patching_rect" : [ 462.0, 462.0, 74.0, 20.0 ],
					"id" : "obj-81",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 519.0, 113.0, 418.0, 230.0 ],
						"bglocked" : 0,
						"defrect" : [ 519.0, 113.0, 418.0, 230.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "because jit.gl.isosurf is centered, but our agent coordinates are in 0..1",
									"linecount" : 3,
									"patching_rect" : [ 225.0, 90.0, 150.0, 48.0 ],
									"id" : "obj-4",
									"fontname" : "Arial",
									"numinlets" : 1,
									"numoutlets" : 0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 60.0, 90.0, 123.0, 20.0 ],
									"id" : "obj-3",
									"fontname" : "Arial",
									"numinlets" : 2,
									"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "isolevel $1",
					"patching_rect" : [ 532.0, 350.0, 68.0, 18.0 ],
					"id" : "obj-77",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p move",
					"patching_rect" : [ 462.0, 196.0, 51.0, 20.0 ],
					"id" : "obj-75",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 519.0, 113.0, 350.0, 436.0 ],
						"bglocked" : 0,
						"defrect" : [ 519.0, 113.0, 350.0, 436.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 60.0, 90.0, 117.0, 20.0 ],
									"id" : "obj-42",
									"fontname" : "Arial",
									"numinlets" : 1,
									"numoutlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jit.op @op - @val 0.5",
									"patching_rect" : [ 60.0, 135.0, 123.0, 20.0 ],
									"id" : "obj-3",
									"fontname" : "Arial",
									"numinlets" : 2,
									"numoutlets" : 2,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 60.0, 210.0, 216.0, 20.0 ],
									"id" : "obj-52",
									"fontname" : "Arial",
									"numinlets" : 1,
									"numoutlets" : 2,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 60.0, 300.0, 138.0, 20.0 ],
									"id" : "obj-2",
									"fontname" : "Arial",
									"numinlets" : 2,
									"numoutlets" : 2,
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-1", 1 ],
									"hidden" : 0,
									"midpoints" : [ 69.5, 329.0, 207.5, 329.0, 207.5, 260.0, 125.5, 260.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 574.0, 196.0, 121.0, 20.0 ],
					"id" : "obj-49",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "accum",
					"patching_rect" : [ 756.0, 322.0, 38.0, 18.0 ],
					"id" : "obj-43",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "decay",
					"patching_rect" : [ 742.0, 252.0, 38.0, 18.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 728.0, 294.0, 130.0, 20.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "clear, bang",
					"patching_rect" : [ 812.0, 182.0, 71.0, 18.0 ],
					"id" : "obj-25",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.isosurf cosm @scale 64 @poly_mode 1 1 @lighting_enable 1 @smooth_shading 1 @color 1 1 1 0.5 @isolevel 0.3 @dim 32 32 32",
					"linecount" : 2,
					"patching_rect" : [ 532.0, 420.0, 572.0, 34.0 ],
					"id" : "obj-23",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadbang",
					"patching_rect" : [ 728.0, 182.0, 61.0, 20.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r step",
					"patching_rect" : [ 462.0, 168.0, 41.0, 20.0 ],
					"id" : "obj-20",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.op @op +",
					"patching_rect" : [ 672.0, 322.0, 75.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 728.0, 224.0, 155.0, 20.0 ],
					"id" : "obj-44",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 574.0, 294.0, 125.0, 20.0 ],
					"id" : "obj-45",
					"fontname" : "Arial",
					"numinlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "cosm.gl.bounds cosm @color 1 1 1 0.05 @lighting_enable 1 @blend_enable 1 @blend_mode 6 7 @infinite 0",
					"linecount" : 3,
					"patching_rect" : [ 182.0, 350.0, 217.0, 41.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 70.0, 378.0, 87.0, 17.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.window cosm @fsmenubar 0 @depthbuffer 1 @pos 0 400",
					"patching_rect" : [ 42.0, 406.0, 251.0, 17.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "cosm.render",
					"patching_rect" : [ 28.0, 350.0, 61.0, 17.0 ],
					"id" : "obj-8",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "cosm.master @lens_angle 80. @position 0 0 -10 @spread 0.05",
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 177.5, 280.5, 51.5, 280.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-23", 0 ],
					"hidden" : 0,
					"midpoints" : [ 681.5, 394.5, 541.5, 394.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-44", 0 ],
					"hidden" : 0,
					"midpoints" : [ 681.5, 379.0, 898.5, 379.0, 898.5, 214.0, 737.5, 214.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-44", 0 ],
					"hidden" : 0,
					"midpoints" : [ 821.5, 210.5, 737.5, 210.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 636.5, 317.5, 681.5, 317.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 737.5, 268.5, 689.5, 268.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-45", 0 ],
					"hidden" : 0,
					"midpoints" : [ 471.5, 283.5, 583.5, 283.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-23", 0 ],
					"hidden" : 0,
					"midpoints" : [ 933.5, 414.5, 541.5, 414.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-45", 1 ],
					"hidden" : 0,
					"midpoints" : [ 583.5, 254.5, 636.5, 254.5 ]
				}
